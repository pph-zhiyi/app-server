package com.pph.demo.java8.design.patterns;

import com.pph.demo.java8.design.patterns.mandator.Editor;
import com.pph.demo.java8.design.patterns.mandator.Macro;
import com.pph.demo.java8.design.patterns.mandator.impl.Operation1;
import com.pph.demo.java8.design.patterns.mandator.impl.Operation2;
import com.pph.demo.java8.design.patterns.observer.Moon;
import com.pph.demo.java8.design.patterns.observer.impl.Aliens;
import com.pph.demo.java8.design.patterns.observer.impl.Nasa;
import com.pph.demo.java8.design.patterns.strategy.Compressor;
import com.pph.demo.java8.design.patterns.strategy.impl.GzipCompressionStrategy;
import com.pph.demo.java8.design.patterns.strategy.impl.ZipCompressionStrategy;
import com.pph.demo.java8.design.patterns.template.ApplicationDenied;
import com.pph.demo.java8.design.patterns.template.la.Company01;
import com.pph.demo.java8.design.patterns.template.la.Company02;
import com.pph.demo.java8.design.patterns.template.la.CompanyLoanApplication;
import com.pph.demo.java8.design.patterns.template.la.LoanApplication;
